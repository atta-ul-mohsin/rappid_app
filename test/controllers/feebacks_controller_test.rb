...
class FeebacksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create feeback" do
    assert_difference('Feeback.count') do
      post feebacks_url, params: { feeback: { content: @feeback.content, grade: @feeback.grade, user_id: @feeback.user_id } }
    end
  ...
  test "should update feeback" do
    patch feeback_url(@feeback), params: { feeback: { content: @feeback.content, grade: @feeback.grade, user_id: @feeback.user_id } }
